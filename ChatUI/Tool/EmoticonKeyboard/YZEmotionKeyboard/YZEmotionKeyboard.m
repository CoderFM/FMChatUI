...
- (void)awakeFromNib
{
    ...
    // didClickSend
//    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(clickSend) name:@"didClickSend" object:nil];
}
...
//    textAttr boundingRectWithSize:<#(CGSize)#> options:<#(NSStringDrawingOptions)#> context:<#(nullable NSStringDrawingContext *)#>
...
- (void)setupCollectionView
{
    ...
    layout.itemSize = CGSizeMake(ScreenW, margin * 4 + emotionWH * 3);
